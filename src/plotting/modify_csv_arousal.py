...
def add_classes_and_save_to_csv(project_dir, file):
    ...
    csv_path_valence = os.path.join(project_dir, "RECOLA-Annotation", "emotional_behaviour", "arousal", file)
    ...
    output_csv_path = os.path.join(project_dir, "arousal_classes_csv", file)
