...
for file in files:
    ...
    csv_path = os.path.join(project_dir, "dataset_csv_ecg_arousal", file) # dataset_csv_eda_arousal, dataset_csv_eda_valence, dataset_csv_ecg_arousal, dataset_csv_edg_valence
    # Load and concatenate all CSV files into a single DataFrame
...
output_csv_path = os.path.join(project_dir, "dataset_csv_ecg_arousal", "merged_dataset2.csv")
