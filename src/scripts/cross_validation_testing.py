...
csv_path_ecg = os.path.join(project_dir_ecg, '../datasets/', "dataset_csv_ecg_arousal", file_ecg)
...
csv_path_eda = os.path.join(project_dir_eda, '../datasets/', "dataset_csv_eda_arousal", file_eda)
