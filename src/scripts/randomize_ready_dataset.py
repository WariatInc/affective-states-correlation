...
file = "merged_dataset.csv"
# Load the CSV file using the project directory
csv_path_valence = os.path.join(project_dir, "../datasets/dataset_csv_eda_valence", file)
...
output_csv_path = os.path.join(project_dir, "../datasets/dataset_csv_eda_valence", "triplicated_merged_dataset.csv")
