...
def mark_peaks_and_save_to_csv_EDA(project_dir, file, extended_peaks):
    ...
    output_csv_path = os.path.join(project_dir, "../datasets/EDA_peaks_determined_csv", f"{file}_peaks.csv")
...
# python src/plotting_scripts/modify_csv_eda.py P16.csv && python src/plotting_scripts/modify_csv_eda.py P19.csv && python src/plotting_scripts/modify_csv_eda.py P21.csv && python src/plotting_scripts/modify_csv_eda.py P23.csv && python src/plotting_scripts/modify_csv_eda.py P25.csv && python src/plotting_scripts/modify_csv_eda.py P26.csv && python src/plotting_scripts/modify_csv_eda.py P28.csv && python src/plotting_scripts/modify_csv_eda.py P30.csv && python src/plotting_scripts/modify_csv_eda.py P34.csv && python src/plotting_scripts/modify_csv_eda.py P37.csv && python src/plotting_scripts/modify_csv_eda.py P39.csv && python src/plotting_scripts/modify_csv_eda.py P41.csv && python src/plotting_scripts/modify_csv_eda.py P42.csv && python src/plotting_scripts/modify_csv_eda.py P45.csv && python src/plotting_scripts/modify_csv_eda.py P46.csv && python src/plotting_scripts/modify_csv_eda.py P56.csv && python src/plotting_scripts/modify_csv_eda.py P64.csv && python src/plotting_scripts/modify_csv_eda.py P65.csv
