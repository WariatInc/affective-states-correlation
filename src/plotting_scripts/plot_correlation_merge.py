...
csv_path_valence = os.path.join(project_dir, "../datasets/RECOLA-Annotation", "emotional_behaviour", "valence")
csv_path_list_valence = glob.glob(csv_path_valence + '/*')

csv_path_arousal = os.path.join(project_dir, "../datasets/RECOLA-Annotation", "emotional_behaviour", "arousal")
